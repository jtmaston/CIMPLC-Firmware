...
(library Library_1
	...
	(patternDef "TC0203620000G" (originalName "TC0203620000G")
		...
		(layerContents (layerNumRef 18)
			(attr "RefDes" "RefDes" (pt 2.500, 0.450) (textStyleRef "Normal") (isVisible True))
		)
		(layerContents (layerNumRef 28)
			(line (pt -3.1 4.2) (pt 8.1 4.2) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 8.1 4.2) (pt 8.1 -3.3) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 8.1 -3.3) (pt -3.1 -3.3) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt -3.1 -3.3) (pt -3.1 4.2) (width 0.025))
		)
		(layerContents (layerNumRef 18)
	...
	(compDef "TC0203620000G" (originalName "TC0203620000G") (compHeader (numPins 2) (numParts 1) (refDesPrefix J)
		...
		(attr "<Hyperlink>" "https://componentsearchengine.com/Datasheets/1/TC0203620000G.pdf")
		(attr "<Component Height>" "10.5")
		(attr "<STEP Filename>" "TC0203620000G.stp")
