...
//963159/279119/2.50/8/3/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "TLV07IDR" (originalName "TLV07IDR")
	...
	(compDef "TLV07IDR" (originalName "TLV07IDR") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "TLV07IDR"))
		...
		(attr "Mouser Part Number" "595-TLV07IDR")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Texas-Instruments/TLV07IDR?qs=EU6FO9ffTweu%2FaLhAoRzmg%3D%3D")
		(attr "Manufacturer_Name" "Texas Instruments")
		(attr "Manufacturer_Part_Number" "TLV07IDR")
		(attr "Description" "36-V Precision, Rail-to-Rail Output, Operational Amplifier")
		(attr "<Hyperlink>" "http://www.ti.com/lit/gpn/tlv07")
		(attr "<Component Height>" "1.75")
		(attr "<STEP Filename>" "TLV07IDR.stp")
